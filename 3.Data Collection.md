...
| Emotion Recognition | Affective state analysis during interactions | viso.ai,Affectiva, Realeyes | High |

**Implementation Example:**

def collect_employee_feedback(employee_id, topic):
    prompt = f"""
    You are conducting a pulse survey about {topic} for employee ID: {employee_id}.
    
    Follow this structure:
    1. Begin with a warm greeting and brief introduction: "I'd like to ask a few questions about your experience with {topic}."
    2. Ask a total of 5 questions in a conversational style.
    3. Start with an employee Net Promoter Score (e-NPS) type question.
    4. Each subsequent question should build on the previous answer, making the conversation feel dynamic and personalized.
    5. Use a mix of scale-based questions (1-10 ratings) and open-ended questions.
    6. End with a thank you message and explain how this feedback will be used.
    
    Keep responses empathetic, professional, and concise.
    """
